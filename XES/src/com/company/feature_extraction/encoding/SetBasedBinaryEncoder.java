...
public class SetBasedBinaryEncoder {
  ...
  public SetBasedBinaryEncoder(XLogManager xLogManager,
      ArrayList<ArrayList<String>> frequentItemstets) {
  ...
  /**
   * Main function of encoding traces into weka instances.
   */
  public void encodeTraces( ) {
    ...
    for (XTrace trace : logTracesToEncode) {
      ...
      for (int j = 0; j < frequentItemstets.size(); ++j) {
        ...
        Double count = getCountOfItemSetInInstance(itemSet, eventMap);
   ...
   * @return
   */
  Double getCountOfItemSetInInstance(ArrayList<String> itemSet,
